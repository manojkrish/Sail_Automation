...
public class Dashboard_Widget implements Dashboard_Widget_Interface {
	...
	By Feed_Page_Navigation = By.cssSelector("html body.push-menu div.app-container div.content div div div#dashboard.container div.sail div div.sail-block div.col-md-6.clr-left-pad div.row button.btn.btn-sm.btn-info.sail-link-btn");
	...
	{
		String st[]={"C:\\Users\\Public\\Pictures\\Sample Pictures\\Desert.jpg","C:\\Users\\Public\\Pictures\\Sample Pictures\\Hydrangeas.jpg","C:\\Users\\Public\\Pictures\\Sample Pictures\\Jellyfish.jpg,D:\\Files\\Test_1.xls"};
		{
			for(int i=0; i<st.length;i++)
			{
